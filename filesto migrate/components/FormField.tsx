  ...
  return (
    <View className={otherStyles + ' '}>
      <Animated.View
        ...
        className={`flex flex-row items-center justify-center rounded-xl w-full h-[50px] px-4 bg-[#F3F3F3] border-2 border-[#A8A8A9] focus:border-black-200 ${
        ...
        {/* TextInput */}
        <TextInput
          className="flex-1 text-black-100 font-semibold text-base text-center"
          value={value}
