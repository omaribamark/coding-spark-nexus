...
/**
 * Component to render rich text with clickable links and formatted topics
 * - Removes numbered lists (1., 2., etc.) and replaces with bullets
 * - Makes topics (text before colons) bold
 * - Converts URLs to clickable blue links with proper wrapping
 * - Removes double brackets from links [[1]], [[2]], etc.
 */
